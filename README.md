...
> 使用方法：完成一道题后，把 `- [ ]` 改成 `- [x]`。GitHub 会自动渲染为已勾选的待办项。
>
> 推荐顺序：数组与字符串 → 链表 → 栈与队列 → 二分 → 二叉树 → DFS/BFS → 回溯 → 贪心 → 动态规划。
...
> [237. 删除链表中的节点](https://leetcode.cn/problems/delete-node-in-a-linked-list/) 题型比较特殊，可作为补充题。
